...
export function Hero({ githubUrl }: HeroProps) {
  return (
    <section className="relative min-h-[70vh] md:min-h-[90vh] flex flex-col items-center py-16 md:py-24 lg:py-32 bg-grid overflow-hidden">
      {/* Radial accent glow at top center */}
      <div
      ...
      <div className="section-inner flex-1 flex items-center relative z-10">
        <div className="max-w-2xl">
          {/* Mono label */}
            <p className="reveal font-mono text-sm uppercase tracking-widest text-[#E8841A] mb-6 animate-fade-up">
            ...
            <div className="reveal reveal-delay-3 flex flex-wrap gap-4 animate-fade-up-delay-2">
              <a
                ...
                className="btn-shine inline-block px-6 py-3 bg-[#2D5A27] text-white text-sm font-mono font-medium uppercase tracking-wider no-underline transition-opacity hover:opacity-90"
